#!/usr/local/bin/bash
# Load ElevenLabs API key from 1Password
export ELEVENLABS_API_KEY=$(op run --env-file=/Users/kieransteele/git/envs/mcps_1p.env -- bash -c 'echo $L1_elevenlabs_apikey')
#
